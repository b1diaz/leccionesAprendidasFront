...
const LeftSidebar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-16 lg:h-full lg:w-16 border-b lg:border-b-0 bg-white flex lg:flex-col items-center justify-center lg:justify-start py-2 lg:py-6 px-4 lg:px-0 z-10">
